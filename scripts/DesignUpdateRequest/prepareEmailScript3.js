...
var user = $.usertasks.usertask3.last.recipientUsers;
var text = "This is a Work Item Email notification.";
var taskInstanceId = $.usertasks.usertask3.last.id;
...
$.context.reqMailBody = {
	"mail": {
		...
		"task": {
			"name": $.usertasks.usertask3.last.subject,
			"description": $.usertasks.usertask3.last.description,
